  ...
  <div class="modal-dialog modal-notify modal-success" role="document">
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
              <a type="button" href="results.php?subj=<?php echo $subj; ?>" class="btn btn-success">Test Results<i class="fa fa-diamond ml-1"></i></a>
              <a type="button" href="review.php?subj=<?php echo $subj; ?>" class="btn btn-outline-success waves-effect">Check Your Test</a>
          </div>
      </div>
      <!--/.Content-->
  </div>
