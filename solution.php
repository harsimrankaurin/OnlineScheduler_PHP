      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="text-center">
                  ...
                  <p class="container">Correct Questions : <?php echo $_SESSION["correct_questions"]; ?><br> Wrong Questions : <?php echo $_SESSION["wrong_questions"]; ?><br>
									Total Questions : <?php echo $_SESSION["total_questions"]; ?></p>
              </div>
          </div>
          ...
          <div class="modal-footer justify-content-center">
			  ...
			  <a type="button" class="btn btn-outline-success waves-effect" data-dismiss="modal">Test Evaluation</a>
          </div>
      </div>
      <!--/.Content-->
  </div>
